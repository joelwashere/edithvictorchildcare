  ...
  return (
    <section className="bg-[#77dd77] flex flex-col pt-10 pb-20 px-8 justify-center items-center text-white">
      ...
      <form className="flex flex-col gap-4 mt-10 px-10 lg:mt-14 min-w-full md:min-w-[500px] xl:min-w-[600px]">
        ...
        <input id="email" name="email" className="p-2 m-1 bg-[#f2f2f2] text-white outline-none border-2 border-white font-semibold rounded" placeholder="Email" type={"email"} />
        <textarea id="message" name="message" required maxLength={2048} className="p-2 m-1 bg-[#f2f2f2] text-white outline-none border-2 border-white font-semibold rounded min-h-[16em]" placeholder="Additional information" />
