...
export const Navbar: FC = (props: any) => {
  ...
  return (
    <nav className={"text-[#f2f2f2] absolute flex h-10 w-full py-6 px-3 justify-between items-center "+ (props.style)} >
      <Link href={"/"}>
        <div className="text-center text-2xl my-auto md:text-2xl lg:text-3xl font-bold p-1 hover:cursor-pointer">
...
export const NavItem = (props: any) => {
  return (
    <Link href={props.href}>
      <li className="mx-2 hover:text-blue-500 font-semibold text-xl">
        {props.icon}
        {props.text}
      </li>
    </Link>
